...
for view_num in range(5):
    ...
    outfile = codecs.open('compare/avg_cpr_CDCombine_' + data_name + '.txt', 'w', 'utf-8')
    ...
    for i in range(1, 11):
        print 'Loading....avg_sk_CDCombine_7009_train_' + str(i) + '.pkl'
        clf = joblib.load('pickle/avg_sk_CDCombine_7009_train_' + str(i) + '.pkl')
        print 'Load done.'
    ...
    outfile = codecs.open('compare/max_cpr_CDCombine_' + data_name + '.txt', 'w', 'utf-8')
    ...
    for i in range(1, 11):
        print 'Loading....max_sk_CDCombine_7002_train_' + str(i) + '.pkl'
        clf = joblib.load('pickle/max_sk_CDCombine_7002_train_' + str(i) + '.pkl')
        print 'Load done.'
