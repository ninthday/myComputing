...
outfile = codecs.open('report/avg_sk_alldb_' + str(len_avg_vd) + '_train_result.txt', 'w', 'utf-8')
...
for train_index_list, test_index_list in avg_sk_fold:
    ...
    joblib.dump(clf, 'pickle/avg_sk_all_' + str(len_avg_vd) + '_train_' + str(i) + '.pkl', compress=9)
...
for train_index_list, test_index_list in k_fold:
"""
outfile = codecs.open('report/max_sk_alldb_' + str(len_max_vd) + '_train_result.txt', 'w', 'utf-8')
outfile.write("Cross-validation: Stratified 10-fold CV\n")
...
for train_index_list, test_index_list in avg_sk_fold:
    ...
    joblib.dump(clf, 'pickle/max_sk_all_' + str(len_max_vd) + '_train_' + str(i) + '.pkl', compress=9)
