...
for source_db in range(5):
    ...
    source_data_name = (tfidf_viewlist[source_db]).replace('VIEW_CateTFIDF', '')

    for view_num in range(5):
        if source_db == view_num:
            continue
        else:
            ...
            outfile = codecs.open('compare/avg_cpr_' + source_data_name + '_' + data_name + '.txt', 'w', 'utf-8')
            ...
            for i in range(1, 11):
                print 'Loading....avg_sk_' + source_data_name + '_7009_train_' + str(i) + '.pkl'
                clf = joblib.load('pickle/avg_sk_' + source_data_name + '_7009_train_' + str(i) + '.pkl')
                print 'Load done.'
            ...
            outfile = codecs.open('compare/max_cpr_' + source_data_name + '_' + data_name + '.txt', 'w', 'utf-8')
            ...
            for i in range(1, 11):
                print 'Loading....max_sk_' + source_data_name + '_7002_train_' + str(i) + '.pkl'
                clf = joblib.load('pickle/max_sk_' + source_data_name + '_7002_train_' + str(i) + '.pkl')
                print 'Load done.'
